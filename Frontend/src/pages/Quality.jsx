...
//             {qualityProcesses.map((process, index) => <div key={index} className="text-center">
...
//             {standards.map((standard, index) => <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
//                 <img src={standard.image} alt={standard.name} className="w-full h-48 object-cover" />
//                 <div className="p-6">
...
//                 {testingEquipment.map((equipment, index) => <div key={index} className="flex items-center">
...
//             </div>
//             <div>
//               <img src="https://images.unsplash.com/photo-1581092160607-ee22621dd758?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Quality testing equipment" className="rounded-lg shadow-lg" />
//             </div>
//           </div>
//         </div>
//       </section>
...
//         </p>
//         <a href="../assets/Registration.pdf" download className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors inline-block">
//         Download PDF</a>
//       </div>
//       {/* ISO 14001 */}
//       <div className="bg-white p-6 rounded-lg shadow-md text-center">
...
//         </p>
//         <a href="../assets/Management.pdf" download className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition-colors inline-block" >
//         Download PDF </a>
//       </div>
//     </div>
//   </div>
...
import Register from '../assets/Registration.jpeg';
import Management from '../assets/Management.jpeg';
import Registerpdf form '../assets/Registration.pdf';
import Managepdf from '../assets/Management.pdf';
const handleresgisterpdf = () => {
  ...
  return <div className="w-full">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md text-center">
        ...
        <button  onClick={handlemanagepdf}className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors inline-block">
        Download PDF</button>
      </div>
      {/* ISO 14001 */}
      <div className="bg-white p-6 rounded-lg shadow-md text-center">
      ...
      <button onClick={handleresgisterpdf} className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition-colors inline-block">
        Download PDF </button>
      </div>
    </div>
  </div>
